...
document.getElementById("name_to_sketch").innerHTML = "name_to_sketch : " + Element_of_array;
...
function update_canvas() 
{
    ...
    document.getElementById("name_to_sketch").innerHTML = "Sketch to be draw : " + sketch;
